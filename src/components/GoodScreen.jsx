...
const GoodScreen = ({ puntos, listaComidas }) => {
  const categorias = {};
    ...
    <div className="main">
      <div className="top">
        <h1 className="animated-text">
          <img className="excelent-image" src="src/assets/1.svg" alt="excelente" />
        </h1>
      </div>
      <div className="display">
        ...
        <div className="left">
          <img src="src/assets/festejo.webp" alt="Héroe" className="imagen-heroe"/>
        </div>
      </div>
    </div>
  );
